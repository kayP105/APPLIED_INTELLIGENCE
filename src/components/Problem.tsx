      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '55fr 38fr', gap: isMobile ? '24px' : '40px', alignItems: 'start' }}>
          ...
          <div>
            <FadeUp>
              <div style={{
                ...
                <span style={{ width: 24, height: 1, background: '#e8c37a', flexShrink: 0, display: 'inline-block' }} />
            ...
            <FadeUp delay={0.2}>
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '0.9rem', color: 'rgba(255,255,255,0.7)', lineHeight: 1.8, marginBottom: '8px' }}>
              ...
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '0.9rem', color: 'rgba(255,255,255,0.7)',lineHeight: 1.8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <FadeUp delay={0.2}>
              <div style={{ background: '#eee7d9', borderRadius: 3, padding: '20px 22px' }}>
                <div style={{ fontFamily: "'Playfair Display', serif", fontStyle: 'italic', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#0b1f3a', marginBottom: 6 }}>The Majority</div>
                <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '2rem', fontWeight: 900, color: '#e8c37a', lineHeight: 1, marginBottom: 8 }}>Non-engineers</div>
                <p style={{ fontSize: '0.8rem', color: 'rgba(11,31,58,0.75)', lineHeight: 1.55, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
...
borderLeft: '3px solid #e8c37a', padding: '16px 18px' }}>
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: '0.95rem', fontWeight: 700, color: '#ffffff', lineHeight: 1.5 }}>
              ...
              >
                ...
                <div style={{ position: 'relative', width: '100%', aspectRatio: '16/5', background: '#7eb5b5', overflow: 'hidden', flexShrink: 0 }}>
                  ...
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(11,31,58,0.8), rgba(37,99,235,0.5))',
                    zIndex: 1,
                  }}>
                ...
                {/* Text */}
                <div style={{ padding: '16px 16px 18px', flex: 1, background: '#092a56' }}>
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '0.95rem', fontWeight: 700, color: '#ffffff', marginBottom: 7, lineHeight: 1.3 }}>
                    {card.title}
                  </h3>
                  <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.7)', lineHeight: 1.65, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    {card.body}
                  </p>
                </div>
              </div>
